...
def getblocksVisual(mode, sourcecode, badpositions, commentareas, fulllength, step, nr, w2v_model, model, threshold, name,folder,folder_name,file_name,id):
      ...
      img = Image.new('RGBA', (2000, 11*(lines+10)))
      color = "white"
...
#            print(list(focusarea))
            ...
            if focusarea[0] == "\n":
                ...
                bbox = d.textbbox((xpos, ypos), focusarea[1:], font=font)
                xpos += bbox[2] - bbox[0]  # Width of the text
            else:
                
                d.text((xpos, ypos), focusarea, fill=color, font=font)
                bbox = d.textbbox((xpos, ypos), focusarea, font=font)
                xpos += bbox[2] - bbox[0]  # Width of the text
      ...
      #print(string)
      if not os.path.exists('../api/uploads/'+folder_name+'/output/'):
        os.makedirs('../api/uploads/'+folder_name+'/output/')
      img.save('../api/uploads/'+folder_name+'/output/'+id+"_"+file_name +"_"+ mode + '.png')
      print("saved png at" + '../api/uploads/'+folder_name+'/output/'+file_name +"_"+ mode + '.png')
